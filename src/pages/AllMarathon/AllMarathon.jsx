...
// const AllMarathon = () => {
//     const [marathons, setMarathons] = useState([]); // Initialize as an empty array
...
//                 setMarathons(response.data.marathons || []); // Fallback to empty array
//                 setTotalPages(response.data.totalPages || 1); // Fallback to 1 page
//                 setLoading(false);
//             } catch (err) {
